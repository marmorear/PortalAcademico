<%@page import="br.portalacademico.model.Aluno"%>
                ...
                <table class="table justify-content-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <%
                                String params = String.format("&idAluno=%s&nome=%s&ra=%s&idCurso=%s", 
                                        a.getIdAluno(), a.getNomeAluno(), a.getRa(), a.getCurso().getIdCurso());
                            %>
                            
                            <td class="text-center"><a class="btn btn-outline-dark" href="<%=request.getContextPath()%>/AlunoController?acao=LOAD<%=params%>">Editar</a></td>

                            
                            <% if (mostraPainelFiltro) {%>
                            <td class="text-center"><a class="btn btn-outline-danger" id="deleteAluno" 
                                                       href="../AlunoController?acao=DELETE&idCurso=<%=a.getCurso().getIdCurso()%>&idAluno=<%=a.getIdAluno()%>">Excluir</a></td>
                                <% } else {%>
                            <td class="text-center"><a class="btn btn-outline-danger" id="deleteAluno" 
                                                       href="../AlunoController?acao=DELETE&idAluno=<%=a.getIdAluno()%>">Excluir</a></td>
                                <% } %>
                        </tr>
                        <% }%>
                    </tbody>
