<%@page import="br.portalacademico.model.Curso"%>
                ...
                <div class="table-responsive-md" style="width: 90%; margin: 0 auto;">
                    <table class="table justify-content-center">
                        ...
                        <tr>
                            ...
                            <% } else {%>
                            <td class="text-center">
                                <a class="btn btn-outline-primary" href="./loader.jsp?pagina=aluno&idCurso=<%=c.getKey().getIdCurso()%>">Alunos Matriculados</a>
                            </td>
                            <% } %>

                            <%
                                String params = String.format("?idCurso=%s&curso=%s&tipo=%s", 
                                        c.getKey().getIdCurso(), c.getKey().getNomeCurso(), c.getKey().getTipoCurso());
                            %>
                            
                            <td class="text-center"><a class="btn btn-outline-dark" href="../cadastros/curso.jsp<%=params%>">Editar</a></td>
                            ...
                            <% } else {%>
                            <td class="text-center">
                                <a class="btn btn-outline-danger" id="deleteCurso" href="../CursoController?acao=DELETE&idCurso=<%=c.getKey().getIdCurso()%>">Excluir</a>
                            </td>
                            <% } %>
                        </tr>
                        <% }%>
